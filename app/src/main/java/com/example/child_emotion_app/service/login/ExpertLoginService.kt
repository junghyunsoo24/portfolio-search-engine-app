package com.example.child_emotion_app.service.login

import com.example.child_emotion_app.data.login.Login
import com.example.child_emotion_app.data.login.LoginResponse
...
object ExpertLoginApi {
    val retrofitService: ExpertLoginService by lazy { retrofit.create(ExpertLoginService::class.java) }
}