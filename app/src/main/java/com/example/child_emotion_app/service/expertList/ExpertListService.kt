package com.example.child_emotion_app.service.expertList
...
import com.example.child_emotion_app.data.expertList.ExpertListResponse
...
interface ExpertListService {
    @Headers("Content-Type: application/json")

    @POST("/manager/experts")
    suspend fun sendsMessage(): Response<ExpertListResponse>

}


object ExpertListApi {
    val retrofitService: ExpertListService by lazy { retrofit.create(ExpertListService::class.java) }
}