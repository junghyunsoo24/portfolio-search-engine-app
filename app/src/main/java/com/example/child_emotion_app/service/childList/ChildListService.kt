...
interface ChildListService {
    @Headers("Content-Type: application/json")

    @POST("/childList")
    suspend fun sendsMessage(@Body message: ChildList): Response<ChildListResponse>

}


object ChildListApi {
    val retrofitService: ChildListService by lazy { retrofit.create(ChildListService::class.java) }
}