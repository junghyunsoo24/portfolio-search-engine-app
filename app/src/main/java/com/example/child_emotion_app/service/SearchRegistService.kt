...
import com.example.child_emotion_app.data.SearchRegistResponse
...
interface SearchRegistService {
    @Headers("Content-Type: application/json")

    @POST("/enrollText")
    suspend fun sendsMessage(@Body message: SearchRegist): Response<SearchRegistResponse>

}


object SearchRegistApi {
    val retrofitService: SearchRegistService by lazy { retrofit.create(SearchRegistService::class.java) }
}