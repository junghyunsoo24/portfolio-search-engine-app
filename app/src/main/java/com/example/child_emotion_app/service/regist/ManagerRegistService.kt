...
interface ManagerRegistService {
    @Headers("Content-Type: application/json")

    @POST("/manager/signUp")
    suspend fun sendsMessage(@Body message: ManagerRegist): Response<RegistResponse>

}

object ManagerRegistApi {
    val retrofitService: ManagerRegistService by lazy { retrofit.create(ManagerRegistService::class.java) }
}