package com.example.child_emotion_app.service.statics
...
import com.example.child_emotion_app.data.statics.OneChildStaticsResponse
...
interface OneChildStaticsService {
    @Headers("Content-Type: application/json")

    @POST("/statistics")
    suspend fun sendsMessage(@Body message: OneChildStatics): Response<OneChildStaticsResponse>

}


object OneChildStaticsApi {
    val retrofitService: OneChildStaticsService by lazy { retrofit.create(OneChildStaticsService::class.java) }
}