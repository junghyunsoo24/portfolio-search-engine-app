package com.example.child_emotion_app.service.childList
...
import com.example.child_emotion_app.data.noAllocateChildList.NoAllocateChildListResponse
...
interface NoAllocateChildListService {
    @Headers("Content-Type: application/json")

    @POST("/manager/unmatchedChildren")
    suspend fun sendsMessage(): Response<NoAllocateChildListResponse>

}


object NoAllocateChildListApi {
    val retrofitService: NoAllocateChildListService by lazy { retrofit.create(NoAllocateChildListService::class.java) }
}